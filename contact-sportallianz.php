    ...
    <section class="breadcrumb_area" style="background-image: url(websiteNEWASSETS/img/contact/whyus_1.jpg); background-size: 100%; background-position: top;background-size:cover;" alt="">
      ...
      <div class="container">
        <div class="breadcrumb_content text-fadeInLeft">
          <h1 class="f_p f_700 f_size_50 w_color l_height50 mb_20">KONTAKT.<br>Zur Sportallianz</h1>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-3 pr-0">
            ...
            <div class="contact_info_item">
              ...
              <p class="f_400 f_size_15"><span class="f_400 t_color3">Telefon:</span> <a href="tel:021612778860">+49 2161 277 8860</a></p>
              <p class="f_400 f_size_15"><span class="f_400 t_color3">Email:</span> <a href="mailto:info@sport-allianz.de">info@sport-allianz.de</a></p>
            </div>
          </div>
          <div class="col-lg-8 offset-lg-1">
            ...
            <div class="dm-forms-widget" data-view="forms" data-formid="177" data-profileid="24082" data-getfields="true" data-bootstrap="true" data-apikey="inMTdkr6s5SivGJrwPZkbRc2594lZBqyYBSqVXmAc7bf26IXeTAezRqZkrXpWfW2" data-callback="" data-uploadfolderid="1"></div>
