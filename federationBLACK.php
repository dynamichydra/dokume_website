          ...
          <div class="col-lg-6 d-flex align-items-center">
            <div class="new_startup_content">
              ...
              <div class="action_btn d-flex align-items-center mt_40 wow fadeInRight" data-wow-delay="0.6s">
                <a href="contact.php?t=2" class="btn_hover app_btn">Demo anfragen <i class="ti-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 d-flex align-items-center">
                    <div class="action_content">
                        ...
                        <a href="contact.php?t=2" class="btn_three btn_hover wow fadeInLeft" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">Überzeuge dich selbst.</a>
